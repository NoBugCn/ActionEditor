...
namespace UnityEditor
{
    ...
    internal class PreviewResizer
    {
            ...
            Rect dragRect)
        {
            ...
            float num2 = (!flag) ? Mathf.Max(0f, m_CachedPref) : PreviewResizer.s_DraggedPreviewSize;
            ...
            bool flag3 = flag2;
            num2 = -PreviewResizer.PixelPreciseCollapsibleSlider(id, position, -num2, -num, 0f, ref flag2);
            ...
            ref bool expanded)
        {
            ...
            switch (current.GetTypeForControl(id))
            {
                ...
                case EventType.MouseDrag:
                    ...
                    {
                        value = Mathf.Clamp(
                            current.mousePosition.y - PreviewResizer.s_MouseDownLocation +
                            PreviewResizer.s_MouseDownValue, min, max - 1f);
                        GUI.changed = true;
